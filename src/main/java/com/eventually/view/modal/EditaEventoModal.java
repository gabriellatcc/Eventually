...
import com.eventually.controller.EditaEventoController;
...
/**
 * Classe responsável pelo modal de "Editar evento".
 * A lógica do controller para esta view deve:
...
public class EditaEventoModal extends Parent {
    private EditaEventoController editaEventoController;
    ...
    private Button btnDecrement, btnIncrement, btnEscolherImagem, btnSalvar, btnCancelar;

    static {
        try {
            Font.loadFont(EditaEventoModal.class.getResource("/fonts/Poppins-Regular.ttf").toExternalForm(), 10);
            Font.loadFont(EditaEventoModal.class.getResource("/fonts/Poppins-Bold.ttf").toExternalForm(), 10);
        } catch (Exception e) {
     ...
     */
    public EditaEventoModal() {
        setup();
    }

    /**
     * Define o controlador para este modal.
     * @param editaEventoController o controller a ser usado.
     */
    public void setEditaEventoController(EditaEventoController editaEventoController) {
        this.editaEventoController = editaEventoController;
    }
    ...
    public VBox criarLayoutPrincipal() {
        ...
        Label titulo = new Label("Editar Evento");
        ...
        hbBotoes.getChildren().addAll(btnSalvar, btnCancelar);
